 ...
 *  subject pools. Each comfortably supports 550 strictly-different shapes
 *  per book (pool size × icons-per-subject, with the keyword's own icon
 *  list padded onto subjects that have a narrow Iconify match set). */
